...
describe('Order Book', () => {
  describe('reconcileOrder', () => {
    ...
    it('10. Extra Credit: it fulfills a mismatched order when both parties benefit', () => {
    ...
    it('11. Extra Credit: it does not fulfill a mismatched order when it does not benefit both parties', () => {
