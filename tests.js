...
describe('Order Book', () => {
  describe('reconcileOrder', () => {
    it('1. adds an order to the book when the book is empty and thus cannot fulfill the order', () => {
      const existingBook = []
    ...
    it('2. adds an order to the book when the book has orders of the corresponding type (i.e. a sell with no buys)', () => {
    ...
    it('3. adds an order to the book when the book has a corresponding order type but it does not match', () => {
    ...
    it.only('5. fulfills an order and reduces the matching order when the book contains a matching order of a larger quantity', () => {
    ...
    it('6. partially fulfills an order, removes the matching order and adds the remainder of the order to the book when the book contains a matching order of a smaller quantity', () => {
      const existingBook = [{ type: 'buy', quantity: 10, price: 6150 }, { type: 'sell', quantity: 12, price: 5950 }]
    ...
    it('8. uses two existing orders to completely fulfill an order, removing the first matching order from the book and reducing the second', () => {
    ...
    it('9. uses two existing orders to partially fulfill an order, removing the matching orders from the book and reducing the incoming order before adding it to the book', () => {
      const existingBook = [{ type: 'buy', quantity: 10, price: 6150 }, { type: 'buy', quantity: 10, price: 6150 }, { type: 'sell', quantity: 12, price: 6950 }]
    ...
    it.skip('10. Extra Credit: it fulfills a mismatched order when both parties benefit', () => {
    ...
    it.skip('11. Extra Credit: it does not fulfill a mismatched order when it does not benefit both parties', () => {
